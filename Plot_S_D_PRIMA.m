...
plot(X1, Y1_Misaligned_Dark, "Color", [107 76 154]./255, "Marker", "*", "LineStyle", "--");
plot(x, BY_eqn,"Color", "m", "LineStyle", "--")
...
legend('Light adapted', "Dark-adapted", "Light misaligned", "Dark misaligned", "RCS")
% "L-AP4",
