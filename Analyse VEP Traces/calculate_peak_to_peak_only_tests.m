function [peak_to_peak_amplitudes, signal_noise_peak_to_peak_amplitude, noise_rms] = calculate_peak_to_peak_only_tests(test_data, laser_intensity, normalize, ymin, ymax, max_time, relative_max_time, noise_detect_time, noise_window, user_title, save_figures, pulse_width)
...
% initialize a figure
fig1 = figure('Position', [0 50 350 150]);
...
for i = 1:number_of_tests
    ...
    ch3_maxrange = ch3((time_ms > 10) & (time_ms < max_time));
    time_maxrange = time_ms((time_ms > 10) & (time_ms < max_time));
